  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="mt-auto text-sm text-green-200 select-none">&copy; 2025 Camarcl Flowershop</div>
      </aside>
        ...
        <header className="fixed top-0 left-0 lg:left-64 right-0 z-30 bg-white shadow-md flex justify-between items-center px-4 lg:px-8 py-3">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                <IconUser />
                <span className="hidden sm:block font-medium">Hi, {user?.name || "Admin"}</span>
              </button>
